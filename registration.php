                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" name="password" id="password" class="form-control">
                                             ...
                                             passwordField.addEventListener('input', function () {
                                                ...
                                                const isValid = /^(?=.*\d)(?=.*[!@#$%^&*])[A-Za-z\d!@#$%^&*]{8,}$/.test(val);

                                                if (val === '') {
                                                   passwordMsg.textContent = '';
                                                } else if (!isValid) {
                                                   passwordMsg.textContent = "❌ Must be 8+ chars, include number & special char";
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="password" class="form-control" id="cpassword" name="cpassword" id="exampleInputPassword2">
                                       <span id="cpassword-msg" style="font-size: 14px;"></span>
                                       <script>
                                             ...
                                             cpasswordField.addEventListener('input', function () {
                                                const val = cpasswordField.value;
                                                ...
                                                if (val === '') {
                                                   ...
                                                   cpasswordMsg.textContent = "✅ Passwords match";
